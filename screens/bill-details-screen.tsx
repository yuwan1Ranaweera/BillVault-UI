...
export function BillDetailsScreen({ onBack }: BillDetailsScreenProps) {
  return (
      ...
      <div className="px-6 pb-20">
        ...
        <Card className="p-6 mb-6 bg-white border border-slate-200 shadow-lg">
            ...
            <div className="w-24 h-32 mx-auto bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl shadow-lg relative overflow-hidden">
              ...
              <div className="absolute inset-2 bg-white rounded-lg p-2">
                <div className="text-center mb-2">
                  ...
                  <div className="text-xs font-bold text-slate-800">SuperMart</div>
                </div>
                ...
                <div className="mt-2 pt-1 border-t border-slate-200">
                  <div className="text-xs font-bold text-slate-800">$45.67</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <h2 className="text-xl font-bold text-slate-900 mb-1">SuperMart Grocery</h2>
            <p className="text-slate-600 mb-4">Receipt #12345</p>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="font-medium text-slate-900">December 10, 2024</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="font-medium text-slate-900">123 Main St, City Center</p>
              </div>
            </div>
        ...
        <Card className="p-4 mb-6 bg-white border border-slate-200 shadow-sm">
          ...
          <div className="space-y-3">
            {[
              ...
              { name: "Chicken Breast", qty: "2 lbs", price: "$12.98" },
            ...
            <div className="flex justify-between items-center pt-3 border-t-2 border-slate-200">
              ...
              <p className="font-bold text-xl text-slate-900">$45.67</p>
            </div>
          </div>
        </Card>
